...
class TestDeploy(PackageIntegBase, DeployIntegBase):
    ...
    def test_package_and_deploy_no_s3_bucket_all_args(self, template_file):
        ...
        with tempfile.NamedTemporaryFile(delete=False) as output_template_file:
            ...
            package_process = self._run_command(command_list=package_command_list, tag="pnd_no_s3_bucket")
            ...
            deploy_process_no_execute = self._run_command(deploy_command_list_no_execute, tag="pnd_no_s3_bucket")
    ...
    def _run_command(self, command_list, tag=None):
    ...
    def _run_command_with_input(self, command_list, stdin_input, tag=None):
